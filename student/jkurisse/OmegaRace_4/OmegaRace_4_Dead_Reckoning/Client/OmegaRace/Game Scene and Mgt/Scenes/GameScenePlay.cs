...
namespace OmegaRace
{
    public class GameScenePlay : IGameScene
    {
        ...
        DataMessage dataMsg;
        public bool isServer = false; // client!
        ...
        {
            // Prediction
            PlayerMgr.P1Data.ship.prediction.MoveToPredictedPosition();
            for (int i = 0; i < PlayerMgr.P1Data.missileList.Count; i++)
                PlayerMgr.P1Data.missileList[i].prediction.MoveToPredictedPosition();

            PlayerMgr.P2Data.ship.prediction.MoveToPredictedPosition();
            for (int i = 0; i < PlayerMgr.P2Data.missileList.Count; i++)
                PlayerMgr.P2Data.missileList[i].prediction.MoveToPredictedPosition();
        }
