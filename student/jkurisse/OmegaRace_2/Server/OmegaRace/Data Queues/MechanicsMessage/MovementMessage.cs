...
namespace OmegaRace
{
    ...
    public class MovementMessage : DataMessage
    {
        ...
        public static MovementMessage Create(PlayerID player, int horz, int vert)
        {
            ...
            msg.destination = DestinationType.Local;
            msg.channel = 10;
            msg.player = player;
            msg.horzInput = horz;
            msg.vertInput = vert;
        ...
        public override void Execute()
        {
            ...
            //Debug.WriteLine($"[MovementMessage] Execute: Player={player}, H={horzInput}, V={vertInput}");
            //
            //if (plMgr.P2Data.ship == null)
            //{
            //    Debug.WriteLine($"[MovementMessage] No ship found for player {player}");
            //    return;
            //}
