...
namespace AzulNetworkBase
{
    class Program
    {
        ...
        static public void AdjustWindow()
        {
            ...
            MoveWindow(hwndFound, (int)rc.Width / 2, (int)rc.Height / 2, (int)rc.Width / 2, (int)rc.Height / 2, true);

            IntPtr hwndFoundg = FindWindow(null, NetworkGame.WindowCaption); // Game window adjustment
            MoveWindow(hwndFoundg, (int)rc.Width / 2, 0, NetworkGame.Width, NetworkGame.Height, true);
        }
        //*******************************************************************
