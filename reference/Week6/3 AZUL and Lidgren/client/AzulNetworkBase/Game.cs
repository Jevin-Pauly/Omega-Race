...
namespace AzulNetworkBase
{
    ...
    {
        public const string WindowCaption = "Moving Squares (Client)";
        ...
        NetworkManager NetworkMgr = new NetworkManager("localhost", 14240);
        ...
        public void MessageToServer(float xdelta, float ydelta)
        {
